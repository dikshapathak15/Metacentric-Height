  ...
  if (f === 1) {
    ...
    if (ins.innerHTML === "Instruction: Click on the start button") {
      ...
      setTimeout(() => {
        ...
        ins.textContent =
          "STEP 1: Click on the scale and measure the level of water.";
    ...
    ins.textContent =
      "STEP 2: Place the pontoon in a tank of water carefully till it becomes stable and observe the changes in water level.";
    startbutton.style.visibility = "hidden";
  } else if (f === 3) {
    f = 4; // Update to the next state if necessary
    ins.textContent =
      "STEP 3: Click on the scale and calculate the amount of water displaced";
    ...
    setTimeout(() => {
      ...
      if (scale) {
        ...
        setTimeout(() => {
          ...
          ins.textContent =
            "STEP 5: Click on the known weight (w) to placed it on the model or hang, ensuring it's initially stable without any oscillations";
